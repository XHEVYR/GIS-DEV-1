    ...
    <div className="w-full space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 rounded-[24px] p-6 shadow-xl shadow-slate-900/20 text-white overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-lime-400 text-xs font-bold uppercase tracking-widest">Total Data</p>
            </div>
            <p className="text-5xl font-black tracking-tight text-white mb-1">
              {totalData}
            </p>
            <p className="text-slate-400 text-sm font-medium">Lokasi Terdaftar</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:shadow-blue-100/50 hover:border-blue-200 transition-all duration-300 group">
          ...
          <div>
            <p className="text-3xl font-black text-slate-800 mb-1">{hotelCount}</p>
            <p className="text-slate-400 text-xs font-bold uppercase tracking-wide">Hotel & Penginapan</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:shadow-orange-100/50 hover:border-orange-200 transition-all duration-300 group">
          ...
          <div>
            <p className="text-3xl font-black text-slate-800 mb-1">{cafeCount}</p>
            <p className="text-slate-400 text-xs font-bold uppercase tracking-wide">Cafe & Resto</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:shadow-purple-100/50 hover:border-purple-200 transition-all duration-300 group">
          ...
          <div>
            <p className="text-3xl font-black text-slate-800 mb-1">{wisataCount}</p>
            <p className="text-slate-400 text-xs font-bold uppercase tracking-wide">Destinasi Wisata</p>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2">
           <div className="bg-white rounded-[32px] p-6 md:p-8 shadow-sm border border-slate-100 h-full">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-bold text-slate-800">Statistik Kategori</h3>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-slate-600 group-hover:text-slate-800">Tambah Data Baru</span>
                </div>
                <ArrowUpRight size={18} className="text-slate-300 group-hover:text-lime-500" />
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-slate-600 group-hover:text-slate-800">Lihat Peta Utama</span>
                </div>
