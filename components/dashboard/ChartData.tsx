...
export default function ChartData({ data }: ChartDataProps) {
  ...
  const barData = [
    { name: "Hotel", total: data.hotel, color: "#2563eb" },
    { name: "Cafe", total: data.cafe, color: "#ea580c" },
    { name: "Wisata", total: data.wisata, color: "#9333ea" },
  ];
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10 w-full">
      ...
      <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
        <h3 className="text-lg font-bold text-slate-800 mb-6">Perbandingan Kategori</h3>
      ...
      <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
        <h3 className="text-lg font-bold text-slate-800 mb-6">Penyebaran Lokasi (%)</h3>
        <div className="h-75 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie
